...
int main() {
    ...
    do {
        ...
        cout << "5. Tambahkan relasi Aktor & Film \n"; 
        cout << "6. Hapus Aktor / Aktris \n";
        cout << "7. Hapus Film \n";
        cout << "8. Hapus Relasi Aktor / Aktris dengan Film\n";
        cout << "9. Hitung Jumlah Film yang diperankan Aktor / Aktris\n";
        cout << "10. Hitung Jumlah Aktor pada Film\n";
        cout << "11. Tampilkan Aktor / Aktris berdasarkan ID \n";
        cout << "12. Tampilkan Film berdasarkan ID \n";
